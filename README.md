...
- 页面优先展示验证码，也可继续读取 Outlook INBOX 最新邮件列表。
- 自动提取验证码并支持点击复制，支持查看邮件全文。
...
- Shows the latest code first, with an optional recent-mail table for troubleshooting.
- Extracts verification codes, supports click-to-copy, and supports full email body preview.
